  ...
  var server = http.createServer(function (request, response) {
    request.addListener('end', function () {
      ...
      try {
        ...
        file.announce(query.peer_id, peer, tracker.event(query.event));
        ...
        var writeResult = file.writePeers(want, query.peer_id);
        var peerBuffer = writeResult.buffer;
        var len = writeResult.count;
