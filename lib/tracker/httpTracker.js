...
function HTTPTracker() {
  HTTPTracker.super_.apply(this, arguments); // Call super's constructor
}
...
HTTPTracker.prototype.handleRequest = function () {
  var that = this;
  ...
  return function _requestHandler(request, response) {
    ...
    try {
      ...
      writeResult = file.writePeers(want, query.peer_id);
